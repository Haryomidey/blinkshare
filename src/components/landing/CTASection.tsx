...
export const CTASection = () => {
    return (
        <section className="min-w-0 overflow-hidden border-t border-neutral-100 bg-white px-4 py-20 sm:py-32">
            <div className="relative mx-auto max-w-4xl min-w-0 overflow-hidden rounded-sm bg-black p-6 text-center sm:p-10 lg:p-16">
                {/* Background Patterns */}
            ...
            <footer className="mt-16 min-w-0 text-center sm:mt-24">
